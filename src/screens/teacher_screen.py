...
from src.components.dailog_share_subject import share_subject_dailog
...
def teacher_dashboard():
            ...
            with tab2:
                ...
                if st.button("Manange Subjects", type= type2,width="stretch", icon=":material/book_ribbon:"):
...
def tecaher_screen_login():
            ...
            st.title("Login Using Passward", text_alignment="center")
            st.space()
            teacher_username = st.text_input("Enter Username", placeholder="Rahul Singh")
...
def register_teacher(teacher_username,teacher_name,teacher_pass,teacher_pass_confirm):
    if not teacher_username or not teacher_name or not teacher_pass:
        return False, "All Field Are Required!S"
...
def teacher_screen_register():
            ...
            with c2:
                if st.button("Go Back To Home", type="secondary", key="teacher_register_back_btn", shortcut="Control+Backspace"):
                    st.session_state["login_type"] = None
                    st.rerun()
            st.title("Register Your Teacher Profile")
            st.space()

            teacher_username = st.text_input("Enter Username", placeholder="rahul_singh")
            teacher_name = st.text_input("Enter Name", placeholder="Rahul Singh")
            teacher_pass = st.text_input("Enter Password", type="password", placeholder="Enter Password")
