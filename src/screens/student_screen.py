...
import time
from src.components.dialog_enroll import enroll_dailog
...
def student_dashboard():
            ...
            for i, sub_node in enumerate(subjects):
                ...
                def unenroll_button():
                    if st.button("Unenrall from this couse",key=f"unenroll_{sid}", type="tertiary", width="stretch", icon=":material/delete_forever:"):
...
def student_screen():
            ...
            if show_registration:
                ...
                try:
                    audio_data = st.audio_input("Record A Short Phrase Like: My Name Is Abhishek, I'm Present")
                except Exception:
