...
def voice_attendance_dialog(selected_subject_id):
    st.write("Record voice of students saying: I'm Present. Then AI Will Recognize the students")
    audio_data = None
    audio_data = st.audio_input("Record Students Voice")
    ...
    if st.button("Analyze Audio", width="stretch", type="primary"):
        with st.spinner("Processing Audio Data"):
            ...
            if not candidates_dict:
                st.error("Student's Voice Profile Is Not Registerd")
                return
